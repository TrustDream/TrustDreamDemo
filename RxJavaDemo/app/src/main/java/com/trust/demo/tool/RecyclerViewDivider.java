...
/**
 * Created by TrustTinker on 2017/4/9.
 */
...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDivider(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public RecyclerViewDivider(int space, int color,int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RecyclerViewDivider(int space, Drawable mDivider) {
        this.space = space;
